...
?>
			...
			<div class="ascendoor-wrapper">
				<div class="site-footer-bottom-wrapper">
					<div class="site-info">
						<?php
						/**
						 * Hook: ascendoor_coach_footer_copyright.
						 *
						 * @hooked - ascendoor_coach_output_footer_copyright_content - 10
						 */
						do_action( 'ascendoor_coach_footer_copyright' );
						?>
					</div><!-- .site-info -->
				</div>
			</div>	
	...
	<?php
	$is_scroll_top_active = get_theme_mod( 'ascendoor_coach_scroll_top', true );
